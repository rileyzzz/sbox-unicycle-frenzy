...
namespace SharpNeat.EvolutionAlgorithms
{
        ...
        where TGenome : class, IGenome<TGenome>
    {
        ...
        public override async Task Initialize(IGenomeListEvaluator<TGenome> genomeListEvaluator,
                                        IGenomeFactory<TGenome> genomeFactory,
                                        List<TGenome> genomeList)
        {
            await base.Initialize(genomeListEvaluator, genomeFactory, genomeList);
			await Initialize();
        }
        ...
        public override async Task Initialize(IGenomeListEvaluator<TGenome> genomeListEvaluator,
                                        ...
                                        int populationSize)
        {
			await base.Initialize(genomeListEvaluator, genomeFactory, populationSize);
			await Initialize();
        }
        ...
        private async Task Initialize()
        {
            ...
            await _genomeListEvaluator.Evaluate(_genomeList);
        ...
        /// </summary>
        protected override async Task PerformOneGeneration()
        {
