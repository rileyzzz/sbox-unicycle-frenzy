...
namespace SharpNeat.EvolutionAlgorithms
{
        ...
        where TGenome : class, IGenome<TGenome>
    {
        ...
        public virtual async Task Initialize(IGenomeListEvaluator<TGenome> genomeListEvaluator,
		...
		public void StartContinue()
		{
			...
			{   // Create a new thread and start it running.
				_algorithmThread = Sandbox.GameTask.RunInThreadAsync( AlgorithmThreadMethod );
				//_algorithmThread = Task.Run( AlgorithmThreadMethod );
			...
			{   // Already running. Log a warning.
				Log.Warning( "StartContinue() called but algorithm is already running." );
			}
			else
			{
		...
		public void RequestPause()
		{
			...
			{
				Log.Warning( "RequestPause() called but algorithm is not running." );
			}
		}
		...
		public void RequestPauseAndWait()
		{
			...
			{
				Log.Warning( "RequestPauseAndWait() called but algorithm is not running." );
			}
		}
        ...
        private async Task AlgorithmThreadMethod()
        {
            try
            {
        ...
        private void OnUpdateEvent()
        {
            if(null != UpdateEvent)
            {
                ...
                try {
                    ...
                    Log.Error("UpdateEvent listener threw exception");
                }
            }
        }
        ...
        private void OnPausedEvent()
        {
            if(null != PausedEvent)
            {
                ...
                try {
					...
					Log.Error("PausedEvent listener threw exception");
                }
            }
        }
        ...
        /// </summary>
        protected abstract Task PerformOneGeneration();
